...
class UAE extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstUAE.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstUAE.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstUAE.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstUAE.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstUAE.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstUAE.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstUAE.won],
        "text": "Won " + [this.state.againstUAE.won]
      },
      {
        "values": [this.state.againstUAE.lost],
        "text": "Lost " + [this.state.againstUAE.lost]
      },
      {
          "values": [this.state.againstUAE.nr],
          "text": "No result " + [this.state.againstUAE.nr]
      }
    ]
    };
    zingchart.render({
