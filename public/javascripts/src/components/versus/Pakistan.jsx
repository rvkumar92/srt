...
class Pakistan extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstPak.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstPak.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstPak.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstPak.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstPak.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstPak.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstPak.won],
        "text": "Won " + [this.state.againstPak.won]
      },
      {
        "values": [this.state.againstPak.lost],
        "text": "Lost " + [this.state.againstPak.lost]
      },
      {
          "values": [this.state.againstPak.nr],
          "text": "No result " + [this.state.againstPak.nr]
      }
    ]
    };
    zingchart.render({
