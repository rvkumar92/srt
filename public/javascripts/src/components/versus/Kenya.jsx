...
class Kenya extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstKY.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstKY.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstKY.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstKY.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstKY.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstKY.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstKY.won],
        "text": "Won " + [this.state.againstKY.won]
      },
      {
        "values": [this.state.againstKY.lost],
        "text": "Lost " + [this.state.againstKY.lost]
      },
      {
          "values": [this.state.againstKY.nr],
          "text": "No result " + [this.state.againstKY.nr]
      }
    ]
    };
    zingchart.render({
