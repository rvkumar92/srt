...
class Australia extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body  panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstAUS.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstAUS.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body  panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstAUS.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstAUS.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstAUS.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstAUS.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstAUS.won],
        "text": "Won " + [this.state.againstAUS.won]
      },
      {
        "values": [this.state.againstAUS.lost],
        "text": "Lost " + [this.state.againstAUS.lost]
      },
      {
          "values": [this.state.againstAUS.nr],
          "text": "No result " + [this.state.againstAUS.nr]
      }
    ]
    };
    zingchart.render({
  ...
  renderAUSChart(){
    ...
    this.state.sachinData.data.map((data,index)=>{
      if(data.opposition == "v Australia"){
        matchPlayed += 1;
