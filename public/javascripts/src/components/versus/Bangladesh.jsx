...
class Bangladesh extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstBAN.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstBAN.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstBAN.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstBAN.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstBAN.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstBAN.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstBAN.won],
        "text": "Won " + [this.state.againstBAN.won]
      },
      {
        "values": [this.state.againstBAN.lost],
        "text": "Lost " + [this.state.againstBAN.lost]
      },
      {
          "values": [this.state.againstBAN.nr],
          "text": "No result " + [this.state.againstBAN.nr]
      }
    ]
    };
    zingchart.render({
  ...
  renderBANChart(){
    ...
    this.state.sachinData.data.map((data,index)=>{
      if(data.opposition == "v Bangladesh"){
        matchPlayed += 1;
