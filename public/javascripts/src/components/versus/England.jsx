...
class England extends Component{
        ...
        <div className="row">
          ...
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Matches</h3>
              <p>{this.state.againstENG.matchPlayed}</p>
              <h3>TotalRuns</h3>
              <p>{this.state.againstENG.totalRuns}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>Wickets</h3>
              <p>{this.state.againstENG.wickets}</p>
              <h3>Catches</h3>
              <p>{this.state.againstENG.catches}</p>
            </div>
          </div>
          </div>
          <div className="col-xs-4">
          <div className="panel panel-default">
            <div className="panel-body panelBackground">
              <h3>50s</h3>
              <p>{this.state.againstENG.fifties}</p>
              <h3>100s</h3>
              <p>{this.state.againstENG.hundreds}</p>
            </div>
          </div>
          </div>
        </div>
  ...
  renderChart(){
    var config = {
      ...
      "series": [
        {
        "values": [this.state.againstENG.won],
        "text": "Won " + [this.state.againstENG.won]
      },
      {
        "values": [this.state.againstENG.lost],
        "text": "Lost " + [this.state.againstENG.lost]
      },
      {
          "values": [this.state.againstENG.nr],
          "text": "No result " + [this.state.againstENG.nr]
      }
    ]
    };
    zingchart.render({
